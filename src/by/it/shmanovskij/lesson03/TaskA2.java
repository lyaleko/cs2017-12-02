...
class TaskA2
{
    ...
    {
    String a="Борьба- иллюзия.", b="Жить в единстве с природой", c="Пойти ли против", d="Естество неизменно.", e="Это должно быть.";
    System.out.println("Моё люмое стихотворение:");

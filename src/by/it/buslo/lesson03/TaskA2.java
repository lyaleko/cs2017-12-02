...
class TaskA2 {
    public static void main(String[] args) {
        String a = "Бывает ли женщина в жизни хоть раз неправа?\n";
        String b = "Безумству вопроса нам следует лишь подивиться.\n";
        String c = "Спросивший такое не просто болван-голова,\n";
        String d = "Но хуже гораздо: практически самоубийца!";

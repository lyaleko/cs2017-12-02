...
class TaskA2 {
    ...
    public static void main(String[] args) {
        ...
        String b = "У лукоморья дуб зеленый, златая цепь на дубе том. ";
        String c = "И днем, и ночью кот ученый все ходит по цепи кругом. ";
        String d = "Идет направо - песнь заводит, налево - сказку говорит. ";
        String e = "Там тишина, там леший бродит, русалка на ветвях сидит.";

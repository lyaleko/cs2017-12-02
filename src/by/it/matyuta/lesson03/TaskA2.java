...
class TaskA2 {
    public static void main(String[] args) {
        String v ="В руках нет силы на груди";
        String d ="держать букет артериальный... ";
        String t ="Так нечет-чёт костей игральных";
        String s ="совпал с количеством гвоздик";
        String m ="моей плиты мемориальной.";

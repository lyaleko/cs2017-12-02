package by.it.matyuta.lesson03;
...
class TaskA1 {
    public static void main(String[] args) {
     ...
     //   System.out.println("Введите числа:");
        int a = sc.nextInt();
        int b = sc.nextInt();
        int s = a+b; int r = a-b; int p = a*b; int c = a/b; int v = a%b;
        double ds = a+b; double dr = a - b; double dp = a*b; double dc = ((double)a/b); double dv = a%b;
        System.out.printf("%d %d %d %d %d", s, r, p, c, v);
        System.out.printf(Locale.ENGLISH,"\n%.1f %.1f %.1f %.1f %.1f",ds,dr,dp,dc,dv);
    }
}
